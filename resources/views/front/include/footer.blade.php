                ...
                <div class="container">
                    <div class="footer-top-wrap">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="{{asset_front('images/logo_only.png')}}" class="logo" alt="logo">
                            </a>
                        </div>
                        <ul class="tf-social-icon style-large">
                            <li>
                                <a target="_blank" href="#" class="social-item social-facebook">
                                    <i class="icon icon-fb"></i>
                                </a>
                            </li>
                            <li>
                                <a target="_blank" href="#" class="social-item social-instagram">
                                    ...
                                    <form action="#" class="form-newsletter" id="subscribe-form" method=" post"
                                        ...
                                        <div id="subscribe-content" class="subscribe-content">
                                            <fieldset class="email">
                                                <input type="email" name="email-form12" id="123subscribe-email"
                                                    class="subscribe-email123" placeholder="Email address"
                            ...
                            <div class="footer-col-block inner-col">
                                ...
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        ...
                                        <li>
                                            <a href="{{ route('return-policy') }}">Returns & Refunds</a>
                                        </li>
                                        <li>
